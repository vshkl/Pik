...
class AlbumsFragment : BaseFragment(), AlbumView, AlbumsListener, SelectionListener, Callback {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        getParrentActivity()?.setSupportActionBar(tbToolbar)
    ...
    override fun onDragSelectionChanged(count: Int) {
        when {
            count != 0 -> {
                when (actionMode) {
                    null -> actionMode = getParrentActivity()?.startSupportActionMode(this)
